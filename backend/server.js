...
httpServer.listen(PORT, () => {
  console.log(`🚀 HTTP Chatbot server running on port ${PORT}`);
...
if (USE_HTTPS && sslOptions) {
  ...
  httpsServer.listen(HTTPS_PORT, () => {
    console.log(`🔒 HTTPS Chatbot server running on port ${HTTPS_PORT}`);
    console.log(`📡 Secure API available at https://localhost:${HTTPS_PORT}`);
    console.log(`💬 Secure chat endpoint: https://localhost:${HTTPS_PORT}/api/chat`);
    console.log(`🏥 Secure health check: https://localhost:${HTTPS_PORT}/api/health`);
  });
}
